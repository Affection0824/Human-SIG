...
def main():
    ...
    if results:
        ...
        with open(stats_output_path, 'w', encoding='utf-8') as f:
            latex_str = df_stats.to_latex(index=False, float_format="%.4f", escape=True)
            # Clean up latex slightly
        ...
        display_cols = ['Figure', 'x_variable', 'y_metric', 'slope', 'p_value', 'n']
