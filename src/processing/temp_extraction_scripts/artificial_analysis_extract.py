"""
临时提取脚本: artificial_analysis
从 data/raw/artificial_analysis/aa_lcr/data.csv 提取模型信息
"""
...
def extract_models():
    ...
    csv_file = base_dir / 'data' / 'raw' / Path('artificial_analysis/aa_lcr/data.csv')
    ...
    print(f"处理了 {len(models)} 个模型: artificial_analysis")
    return models
