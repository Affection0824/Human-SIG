"""
AIME (2025) Leaderboard Scraper (llm-stats.com)

爬取方法: Selenium
URL: https://llm-stats.com/benchmarks/aime-2025
...
def main():
    ...
    if df is not None:
        ...
        output_file = data_dir / "aime_2025_test.csv"
